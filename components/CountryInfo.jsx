  ...
  import Shimmer_inside from './Shimmer_inside';
import { Theme } from '../contexts/ThemeContext';
    ...
    export default function CountryInfo() {
      ...
      then((borders)=>{
        setCountryData(pre=>({...pre,borders}))
      })
      }
      useEffect(()=>{
      ...
      if(notFound){
        return <div>Country is Not found int Globe</div>
      }
    return (
      ...
      <main className={`${!isDark?'dark':''}`}>
        <div className="country-details-container">
          ...
          {countryData==null?(<Shimmer_inside/>) :(<div className="country-details">
